...
def main():
        ...
        i=1
        while(i>0):
            screen.blit(pygame.image.load("2.png"),(0 ,0))
            pygame.display.update()
            i=i-1
        global countRight
        global countLeft
        global run
        global speed, val, voltage
        ...
        wiper = pygame.image.load("wiper.png")
        t1=time.time_ns()
        c=0
        voltage=0
        while run:
            val = speed
            fields=[val,'second','third']
            with open(r'123.csv', 'a') as f:
                writer = csv.writer(f)
            ...
            health_bar = (740,100,20,voltage)
            pygame.draw.rect(screen,(0,255,0),(740,100,20,200))
            pygame.draw.rect(screen,(0,0,0),health_bar)	
            pygame.draw.rect(screen,(255,255,255),(740,100,20,200),4)	
            distance(screen,d1)
            #plotter(screen,val)
